...
import {registerAdmin, loginAdmin,changePassword,logoutAdmin, updateAdminProfile, getAllAgents, deleteAgent, updateAgent, getAllLeads} from "../controllers/Admin/admin.controller.js";
...
router.route("/getLeads").get(verifyAdminJWT,getAllLeads)
